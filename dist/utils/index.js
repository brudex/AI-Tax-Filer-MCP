 ...
 * Validate tax year
 */
export function isValidTaxYear(year) {
...
export function calculateTax(taxableAmount) {
    ...
    for (const bracket of brackets) {
        const taxableInBracket = Math.min(Math.max(remainingAmount, 0), bracket.threshold - previousThreshold);
 ...
 */
export function isValidBusinessRegNumber(regNumber) {
 ...
 */
export function getTaxPeriod(year) {
