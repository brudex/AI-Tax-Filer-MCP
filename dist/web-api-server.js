...
app.get('/api/test', (req, res) => {
    const message = req.query.message || 'Hello from Web API';
    res.json(formatResponse(true, {
        message,
        server: 'gra-tax-processor-web-api',
        status: 'connected',
...
app.post('/api/generate-report', async (req, res) => {
    try {
        const { taxpayerName, taxYear, totalIncome, totalExpenses, totalDeductions, taxableAmount, taxId, businessType } = req.body;
